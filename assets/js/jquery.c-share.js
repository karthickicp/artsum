...
(function (factory) {
  ...
  if ($.fn) {
    $.fn.cShare = function (options) {
      ...
      var defaults = {
        ...
        data: {
          ...
          line: {
            ...
            name: "Line",
            href: function href(url) {
              return "https://social-plugins.line.me/lineit/share?url=".concat(
                url
              );
            },
            show: true,
          ...
          plurk: {
            ...
            href: function href(url, description) {
              return "http://www.plurk.com/?qualifier=shares&status="
                .concat(description, " ")
                .concat(url);
            },
            show: false,
          ...
          tumblr: {
            ...
            name: "Tumblr",
            href: function href(url, description) {
              return "http://www.tumblr.com/share/link?name="
                .concat(description, " ")
                .concat(url, "&url=")
                .concat(url);
            },
      ...
      this.find("[data-icon=fb] .fa-stack-2x").css("color", "#3b7fae");
      ...
      this.find("[data-icon=twitter] .fa-stack-2x").css("color", "#3b7fae");
      this.find("[data-icon=tumblr] .fa-stack-2x").css("color", "#35465d");
      this.find("[data-icon=email] .fa-stack-2x").css("color", "#3b7fae");
      return this;
    };
  }
});
